  ...
  return (
    <div>
      ...
      <div className="flex gap-3 mb-6">
        {summary.added > 0 && (
          <span className="px-2.5 py-1 bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200 rounded-md text-sm font-medium">
            +{summary.added} added
          </span>
        )}
        {summary.removed > 0 && (
          <span className="px-2.5 py-1 bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200 rounded-md text-sm font-medium">
            -{summary.removed} removed
          </span>
        )}
        {summary.changed > 0 && (
          <span className="px-2.5 py-1 bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200 rounded-md text-sm font-medium">
            ~{summary.changed} changed
          </span>
        )}
        {summary.added === 0 && summary.removed === 0 && summary.changed === 0 && (
          <span className="px-2.5 py-1 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 rounded-md text-sm">
            No changes
          </span>
        )}
      </div>
